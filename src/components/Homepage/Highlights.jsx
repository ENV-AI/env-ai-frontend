  ...
  return (
    <div className="my-5 text-white p-3 bg-slate-900 rounded-lg">
      ...
      <div className="flex flex-wrap justify-start items-center gap-3">
        ...
        {/* AQI index */}
        <div className="mt-5 flex flex-start gap-3 relative ">
          <div
            className="p-4 text-gray-400 rounded-lg"
            style={{
              background: getConcernLevel(aqiData?.aqi)
                ? getConcernLevel(aqiData?.aqi).aqiColor
                : "red",
            }}
          ...
          >
            <div className="flex justify-start items-center gap-10">
              <div className="flex flex-col h-full">
                <div className="text-gray-100 text-md mb-2">
                  {location} AQI Index{" "}
                </div>
                <div className="text-gray-100 text-xl my-[10px]">
                  {aqiData?.aqi}{" "}
          ...
          {showTooltip && (
            <div className="absolute bg-black w-[300px] text-white text-sm py-1 px-2 rounded top-20 left-0 mt-8">
              {getConcernLevel(aqiData?.aqi).DespOfAirQuality}
            </div>
          )}
        </div>
